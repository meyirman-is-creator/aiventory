  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium text-[#1f2937]",
        ...
        day_selected:
          "bg-[#6322FE] text-[#ffffff] hover:bg-[#6322FE] hover:text-[#ffffff] focus:bg-[#6322FE] focus:text-[#ffffff]",
        day_today: "bg-[#f3f4f6] text-[#1f2937]",
        day_outside:
          "day-outside text-[#9ca3af] opacity-50 aria-selected:bg-[#f3f4f6]/50 aria-selected:text-[#9ca3af] aria-selected:opacity-30",
