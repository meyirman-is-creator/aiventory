    ...
    <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
      <Card className="bg-[#ffffff] border-[#e5e7eb]">
        ...
        <CardContent className="px-4 sm:px-6">
          <div className="text-lg sm:text-2xl font-bold text-[#1f2937]">{summary.total_items_sold}</div>
      ...
      <Card className="bg-[#ffffff] border-[#e5e7eb]">
        ...
        <CardContent className="px-4 sm:px-6">
          <div className="text-lg sm:text-2xl font-bold text-[#1f2937]">{formatCurrency(summary.total_sales)}</div>
          <p className="text-xs text-[#6b7280]">
            Выручка за 30 дней
          </p>
        </CardContent>
      ...
      <Card className="border-[#fecaca] bg-[#ffffff]">
        ...
        <CardContent className="px-4 sm:px-6">
          <div className="text-lg sm:text-2xl font-bold text-[#7f1d1d]">{formatCurrency(summary.total_removed_value)}</div>
      ...
      <Card className="border-[#c4b5fd] bg-[#ffffff]">
        ...
        <CardContent className="px-4 sm:px-6">
          <div className="text-lg sm:text-2xl font-bold text-[#4c1d95]">{formatCurrency(summary.total_discount_savings)}</div>
